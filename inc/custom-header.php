 ...
 *
 * @uses fifteentwenty_header_style()
 */
function fifteentwenty_custom_header_setup() {
	 ...
	 * }
	 */
	add_theme_support( 'custom-header', apply_filters( 'fifteentwenty_custom_header_args', array(
		'default-text-color'     => $default_text_color,
		'width'                  => 954,
		'height'                 => 1300,
		'wp-head-callback'       => 'fifteentwenty_header_style',
	) ) );
}
add_action( 'after_setup_theme', 'fifteentwenty_custom_header_setup' );
 ...
 */
function fifteentwenty_hex2rgb( $color ) {
	$color = trim( $color, '#' );
 ...
 */
function fifteentwenty_header_style() {
	...
	?>
	<style type="text/css" id="fifteentwenty-header-css">
	<?php
...
endif; // fifteentwenty_header_style
...
function fifteentwenty_header_background_color_css() {
	...
	wp_add_inline_style( 'fifteentwenty-style', sprintf( $css, $header_background_color ) );
}
add_action( 'wp_enqueue_scripts', 'fifteentwenty_header_background_color_css', 11 );
...
function fifteentwenty_sidebar_text_color_css() {
	...
	// If we get this far, we have custom styles. Let's do this.
	$sidebar_link_color_rgb     = fifteentwenty_hex2rgb( $sidebar_link_color );
	...
	wp_add_inline_style( 'fifteentwenty-style', sprintf( $css, $sidebar_link_color, $sidebar_text_color, $sidebar_border_color, $sidebar_border_focus_color ) );
}
add_action( 'wp_enqueue_scripts', 'fifteentwenty_sidebar_text_color_css', 11 );
